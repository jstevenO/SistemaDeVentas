<%-- 
    ...
    Created on : 24/02/2022, 08:48:52 PM
    Author     : steven
--%>
                    ...
                    <form action="Controlador?menu=NuevaVenta" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group d-flex">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="nombresclientes" value="${cl.getNom()}" placeholder="Datos Cliente" class="form-control"> 
                                </div>
                            </div>
                            <!--DATOS DEL PRODUCTO-->
                            <div class="form-group">
                            ...
                            <div class="form-group d-flex">
                                <div class="col-sm-6 d-flex">
                                    ...
                                    <button type="submit" name="accion" value="BuscarProducto" class="btn btn-outline-info">Bucar</button>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group d-flex">
                                <div class="col-sm-6 d-flex">
                                    <input type="text" name="precio"  value="${producto.getPrecio()}"class="form-control" placeholder="3/.0.00">
                                </div>
                                <div class="col-sm-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex  col-sm-6 ml-auto">
                            <lable class="text-right mt-2 col-sm-6" >Nro.Serie:</lable>
